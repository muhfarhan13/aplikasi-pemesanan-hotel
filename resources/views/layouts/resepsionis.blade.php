...
<body class="bg-gray-100">
        ...
        <div class="dropdown relative md:static">
          ...
          <button class="menu-btn focus:outline-none focus:shadow-outline flex flex-wrap items-center">
            <div class="ml-2 capitalize flex ">
              <h1 class="text-sm text-gray-800 font-semibold m-0 p-0 leading-none">Resepsionis</h1>
  ...
  <div class="h-screen flex flex-row flex-wrap">
    ...
    <div id="sideBar"
      ...
      <div class="flex flex-col">
        ...
        <!-- link -->
        <a href="{{ route('home') }}"
          class="{{ request()->is('/') ? 'text-yellow-400' : '' }} mb-3 capitalize text-md font-medium hover:text-yellow-400 transition ease-in-out duration-500 {{ request()->is('home') ? 'text-yellow-400' : '' }}">
          <i class="fad fa-chart-pie mr-2"></i>
          Dashboard
        </a>

        <a href="{{ route('reservasi') }}"
          class="{{ request()->is('reservasi') ? 'text-yellow-400' : '' }} mb-3 capitalize text-md font-medium hover:text-yellow-400 transition ease-in-out duration-500 {{ request()->is('kamar-admin') ? 'text-yellow-400' : '' }}">
          <i class="fad fa-calendar-day mr-3"></i>
          Reservasi
        </a>    
        <!-- end link -->
  ...
  <script src="{{ asset('js/resepsionis.js') }}"></script>
  <!-- end script -->
