...
<body class="bg-gray-100">
  ...
  <div
    ...
    <div class="flex-none w-56 flex flex-row items-center">
      <i class="fa fa-hotel fill-current text-black" aria-hidden="true"></i>
      <strong class="capitalize ml-1 flex-1 text-2xl">GENG<span class="text-yellow-400">GONG</span></strong>
  ...
  <div class="h-screen flex flex-row flex-wrap">
    ...
    <div id="sideBar"
      ...
      <div class="flex flex-col">
        ...
        <!-- link -->
        <a href="{{ route('home') }}"
          class="mb-3 capitalize text-md font-medium hover:text-yellow-400 transition ease-in-out duration-500 {{ request()->is('/') ? 'text-yellow-400' : '' }}">
          <i class="fad fa-chart-pie mr-2"></i>
          Dashboard
        </a>

        <a href="{{ route('kamar') }}"
          class="mb-3 capitalize text-md font-medium hover:text-yellow-400 transition ease-in-out duration-500 {{ request()->is('kamar') ? 'text-yellow-400' : '' }}">
          <i class="fad fa-house mr-2"></i>
          Kamar
        </a>

        <a href="{{ route('fasilitas-kamar') }}"
          class="mb-3 capitalize text-md font-medium hover:text-yellow-400 transition ease-in-out duration-500 {{ request()->is('fasilitas-kamar') ? 'text-yellow-400' : '' }}">
          <i class="fad fa-bed mr-2"></i>
          Fasilitas Kamar
        </a>

        <a href="{{ route('fasilitas-umum') }}"
          class="mb-3 capitalize text-md font-medium hover:text-yellow-400 transition ease-in-out duration-500 {{ request()->is('fasilitas-umum') ? 'text-yellow-400' : '' }}">
          <i class="fad fa-warehouse mr-2"></i>
          Fasilitas Umum
        </a>        
        <!-- end link -->
