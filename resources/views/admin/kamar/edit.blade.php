            ...
            <div class="w-full text-left px-6 py-10">
                <form action="/update-kamar/{{ $kamar->id }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="tipe">
                        ...
                        <input type="text" name="tipe" id="tipe" value="{{ old('tipe', $kamar->tipe) }}" class="border-b-2 border-solid w-55 focus:outline-none p-2 rounded-sm">
                    </div>
                    <div class="harga_kamar mt-5">
                        <label for="harga_kamar" class="block mb-2 font-semibold">Harga_Kamar</label>
                        <input type="text" name="harga_kamar" id="harga_kamar" value="{{ old('harga_kamar', $kamar->harga_kamar) }}" class="border-b-2 border-solid w-55 focus:outline-none p-2 rounded-sm">
                    </div>
                    <div class="jumlah_kamar mt-5">
                        <label for="jumlah_kamar" class="block mb-2 font-semibold">Jumlah Kamar</label>
                        <input type="text" name="jumlah_kamar" id="jumlah_kamar" value="{{ old('jumlah_kamar', $kamar->jumlah_kamar) }}" class="border-b-2 border-solid w-55 focus:outline-none p-2 rounded-sm">
                    </div>
                    <div class="gambar_kamar mt-5">
                        ...
                        <input type="text" name="hidden_image" value="{{ substr($kamar->gambar_kamar, 6) }}" class="">
                    </div>
